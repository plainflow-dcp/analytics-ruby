...
module Plainflow
  class Analytics
    describe Analytics do
      let(:analytics) { Plainflow::Analytics.new :secret_key => SECRET_KEY, :stub => true }
      ...
      describe '#respond_to?' do
        it 'responds to all public instance methods of Plainflow::Analytics::Client' do
          expect(analytics).to respond_to(*Plainflow::Analytics::Client.public_instance_methods(false))
        end
      end

      describe '#method' do
        Plainflow::Analytics::Client.public_instance_methods(false).each do |public_method|
